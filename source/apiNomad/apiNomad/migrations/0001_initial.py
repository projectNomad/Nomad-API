# Generated by Django 2.1.5 on 2019-02-19 21:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        #         ('type', models.CharField(choices=[('account_activation', 'Account activation'), ('password_change', 'Password change')], default=None, max_length=100, verbose_name='Type of action')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gender', models.CharField(choices=[('I', 'Inconnu'), ('M', 'Homme'), ('F', 'Femme')], default='I', max_length=1)),
